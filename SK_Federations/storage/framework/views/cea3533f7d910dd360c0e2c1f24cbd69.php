...
<?php $__env->startPush('styles'); ?>
    <link rel="stylesheet" href="<?php echo e(url('/modules/community_feed/css/community-feed.css')); ?>">
<?php $__env->stopPush(); ?>
...
<div class="cf-container">
            ...
            <div class="feed-section">
                ...
                <div class="sk-fed-card" style="cursor:pointer;" onclick="window.location.href='<?php echo e(route('sk-fed-profile')); ?>'">
                    <div class="sk-fed-card-banner">
                        <img src="<?php echo e(asset('Images/SK_OnePortal.png')); ?>" alt="SK OnePortal Logo" class="sk-fed-card-logo">
            ...
            <aside class="programs-sidebar" id="programsSidebar">
                ...
                <div class="sidebar-card" style="margin-top:16px;">
                    ...
                    <div style="display:flex;flex-direction:column;gap:8px;">
                        ...
                        ?>
                        <?php $__currentLoopData = $brgyList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brgy): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(route('skfed.barangay-profile', ['slug' => $brgy['slug']])); ?>"
                           ...
                           onmouseover="this.style.background='#eef1fb'" onmouseout="this.style.background='#f5f7fa'">
                            <div style="width:38px;height:38px;border-radius:50%;background:<?php echo e($brgy['color']); ?>;display:flex;align-items:center;justify-content:center;font-size:12px;font-weight:800;color:#fff;flex-shrink:0;">
                                <?php echo e(strtoupper(substr($brgy['name'], 0, 2))); ?>

                            </div>
                            <div style="flex:1;min-width:0;">
                                <p style="font-size:13px;font-weight:700;color:#1a1d25;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">Brgy. <?php echo e($brgy['name']); ?></p>
...
<script src="<?php echo e(url('/modules/community_feed/js/community-feed.js')); ?>?v=<?php echo e(filemtime(public_path('modules/community_feed/js/community-feed.js'))); ?>"></script>
<?php $__env->stopPush(); ?>
