<div class="charts-grid-2 dash-feed-row" id="dashboardActivityApp"
     data-activities-url="<?php echo e(route('dashboard.recent-activities')); ?>">
    ...
    <div class="content-card dash-section-card">
        <div class="dash-section-header">
            ...
            <a href="<?php echo e(route('calendar')); ?>" class="dash-view-all">View all</a>
        </div>
...
<?php /**PATH C:\Users\Administrator\Documents\SK_OnePortal_Santa_Cruz\SK_Federations\app\Modules\Dashboard\Providers/../Views/partials/dashboard-recent-activity.blade.php ENDPATH**/ ?>