            ...
            <form id="assignFederationPositionForm" class="account-modal-form" data-account-id="" novalidate>
                ...
                <div class="form-group-light">
                    ...
                    <select id="assign_federation_position" name="federation_position" class="form-input-light">
                        ...
                        <?php $__currentLoopData = \App\Modules\Accounts\Models\OfficialProfile::federationPositionOptions(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH C:\Users\Administrator\Documents\SK_OnePortal_Santa_Cruz\SK_Federations\app\Modules\Accounts\Providers/../Views/assign_federation_position_modal.blade.php ENDPATH**/ ?>