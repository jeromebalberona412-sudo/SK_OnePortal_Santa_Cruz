...
<?php $__env->startSection('content'); ?>
        ...
        <div style="display:grid;grid-template-columns:repeat(7,1fr);gap:16px;margin-bottom:24px;">
            ...
            <a href="<?php echo e(route('archive')); ?>" class="stat-card stat-card-link stat-card-clickable">
        ...
        <div class="content-card" style="margin-bottom:24px;">
            ...
            <div class="card-body" style="padding:20px;overflow-x:auto;">
                <div style="display:flex;gap:12px;flex-wrap:wrap;min-width:fit-content;">
                    ...
                    <a href="<?php echo e(route('reports')); ?>" class="qa-btn" style="display:inline-flex;align-items:center;gap:8px;padding:12px 20px;background:#06b6d4;color:#fff;border-radius:8px;text-decoration:none;font-size:14px;font-weight:500;white-space:nowrap;transition:all 0.2s ease;box-shadow:0 1px 3px rgba(6,182,212,0.3);">
                    ...
                    <a href="<?php echo e(route('archive')); ?>" class="qa-btn" style="display:inline-flex;align-items:center;gap:8px;padding:12px 20px;background:#f59e0b;color:#fff;border-radius:8px;text-decoration:none;font-size:14px;font-weight:500;white-space:nowrap;transition:all 0.2s ease;box-shadow:0 1px 3px rgba(245,158,11,0.3);">
                ...
                <div class="card-body">
                    <div class="kab-stats-summary">
                        <div class="kab-stat-mini blue">
                            <div class="kab-stat-mini-value"><?php echo e(number_format($totalKabataanRegistered ?? 0)); ?></div>
