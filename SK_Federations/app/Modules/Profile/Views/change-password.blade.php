...
@section('content')
    ...
    <form action="{{ route('password.change.update') }}" method="POST" class="sk-login-form" id="change-password-form" data-password-min-length="{{ $pwMin }}" data-password-max-length="{{ $pwMax }}" novalidate>
        @csrf
