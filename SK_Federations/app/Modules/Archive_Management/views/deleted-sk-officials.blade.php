...
@push('styles')
    <link rel="stylesheet" href="{{ url('/modules/archive-management/css/deleted-sk-officials.css') }}?v={{ $cssVersion }}">
@endpush
...
@push('scripts')
    <script src="{{ url('/modules/archive-management/js/deleted-sk-officials.js') }}?v={{ $jsVersion }}"></script>
@endpush
