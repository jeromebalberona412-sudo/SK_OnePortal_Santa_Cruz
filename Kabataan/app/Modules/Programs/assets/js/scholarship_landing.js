/**
 * Scholarship Landing Page JavaScript
 */
(function () {
    'use strict';
    ...
    function loadApplicationStatus() {
        ...
        const currentProgramId = 'scholarship-assistance-2026'; // This would come from URL or API
    ...
    function loadPreviousApplications() {
        ...
        const sampleApplications = [
            {
                id: 'app-001',
                program_name: 'Scholarship Assistance Program 2025',
                submitted_at: 'May 10, 2025',
                status: 'Approved'
            },
            {
                id: 'app-002',
                program_name: 'Educational Grant Program 2024',
                submitted_at: 'June 15, 2024',
                status: 'Rejected'
            },
            {
                id: 'app-003',
                program_name: 'Academic Excellence Award 2023',
        ...
        const currentProgramId = 'scholarship-assistance-2026';
        ...
        const rowsHtml = previousApplications.map(app => {
            ...
            return `
                <tr>
                    <td>${app.program_name || 'Scholarship Program'}</td>
    ...
    function handleStartApplication() {
        ...
        window.location.href = '/scholarship/apply/form';
    }
