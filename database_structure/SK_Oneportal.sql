...
-- Archived KK profiling records (moved from active kabataan_registrations)
create table public.previous_kabataan (
  ...
  middle_name character varying(100) null,
  suffix character varying(10) null,
  age character varying(10) null,
  birthday character varying(30) null,
  sex character varying(20) null,
  civil_status character varying(50) null,
  youth_classification character varying(100) null,
  youth_age_group character varying(100) null,
  email character varying(150) null,
  contact_number character varying(15) null,
  home_address character varying(255) null,
  education character varying(100) null,
  work_status character varying(100) null,
  registered_voter character varying(20) null,
  voted_last_election character varying(20) null,
  kk_assembly character varying(20) null,
  kk_assembly_count character varying(50) null,
  barangay_name character varying(150) null,
  region character varying(100) null,
  province character varying(100) null,
  city character varying(100) null,
  form_data json not null,
  profiling_year integer not null,
