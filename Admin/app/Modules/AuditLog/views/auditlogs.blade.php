                ...
                <form method="GET" action="{{ route('auditlogs.index') }}" class="search-add-container">
                    <div class="filter-dropdown-container">
                        <select id="eventFilter" class="filter-dropdown" name="event">
                            ...
                            <option value="login_blocked_email_unverified" {{ request('event') === 'login_blocked_email_unverified' ? 'selected' : '' }}>
                                login_blocked_email_unverified
                            </option>
                            <option value="login_success" {{ request('event') === 'login_success' ? 'selected' : '' }}>
                                login_success
                            </option>
                            <option value="login_blocked_email_device_changed" {{ request('event') === 'login_blocked_email_device_changed' ? 'selected' : '' }}>
                                login_blocked_email_device_changed
                            </option>
                        </select>
                    </div>
                    <div class="search-container">
                        <input type="text" id="searchInput" name="search" class="search-input" value="{{ request('search') }}" placeholder="Search by user ID or Created At...">
