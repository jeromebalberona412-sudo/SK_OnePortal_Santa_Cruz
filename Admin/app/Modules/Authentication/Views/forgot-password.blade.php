...
<head>
    ...
    <style>
        .fp-icon-wrap {
            ...
            background: linear-gradient(135deg, rgba(8,48,128,.08) 0%, rgba(13,71,161,.12) 100%);
            border: 1.5px solid rgba(8,48,128,.12);
            margin-bottom: 1.25rem;
        }
        .fp-icon-wrap svg { width: 28px; height: 28px; color: #083080; }
    </style>
</head>
<body class="login-page">
    ...
    <div id="signin-overlay" class="signin-overlay" aria-hidden="true" hidden>
        <div class="signin-overlay-inner">
            ...
            <p class="signin-overlay-title">Sending Reset Code</p>
