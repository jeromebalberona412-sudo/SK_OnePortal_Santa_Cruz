...
@section('title', 'OnePortal Admin — Confirm Access')
...
@section('content')
    <div class="login-card-header">
        ...
        <h2 class="login-heading">Confirm Your Identity</h2>
        <p class="login-subheading">For security, please re-enter your password to continue.</p>
    </div>
    ...
    <form method="POST" action="{{ route('password.confirm.store') }}" novalidate>
        ...
        <button type="submit" class="login-btn mb-3">Confirm Identity</button>
