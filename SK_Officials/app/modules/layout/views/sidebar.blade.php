            ...
            <ul class="nav-list">
                ...
                <li class="nav-item">
                    <a href="{{ route('kk-profiling-requests') }}" class="nav-link {{ request()->routeIs('kk-profiling-requests') ? 'active' : '' }}">
                        ...
                        <!-- Pencil Square Icon for KK Profiling (form filling and data entry) -->
                        <svg class="nav-icon" xmlns="http://www.w3.org/2000/svg"
                             viewBox="0 0 24 24"
                             fill="none"
                             stroke="currentColor"
                ...
                <li class="nav-item">
                    <a href="{{ route('abyip.index') }}" class="nav-link {{ request()->routeIs('abyip.*') ? 'active' : '' }}">
                        ...
                        <!-- Document Icon for ABYIP (Bootstrap file-earmark-text) -->
                        <svg class="nav-icon" xmlns="http://www.w3.org/2000/svg"
                             viewBox="0 0 24 24"
                             fill="none"
                             stroke="currentColor"
                ...
                <li class="nav-item nav-item-dropdown" id="archivedDropdown">
                    <a href="#" class="nav-link nav-link-dropdown" onclick="toggleArchivedDropdown(event)">
                        ...
                        <!-- Chevron Icon -->
                        <svg class="nav-chevron" id="archivedChevron" xmlns="http://www.w3.org/2000/svg"
                             viewBox="0 0 24 24"
                             fill="none"
                             stroke="currentColor"
                             stroke-width="2"
                    ...
                    <ul class="nav-submenu" id="archivedSubmenu">
                        ...
                        <li class="nav-subitem">
                            <a href="#" class="nav-sublink">
                                <svg class="nav-subicon" xmlns="http://www.w3.org/2000/svg"
                                     viewBox="0 0 24 24"
                                     fill="none"
                                     stroke="currentColor"
                                     stroke-width="2"
