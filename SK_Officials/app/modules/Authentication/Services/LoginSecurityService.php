...
class LoginSecurityService
{
    ...
    {
        $windowMinutes = (int) config('sk_official_auth.rate_limit.window_minutes', 15);
        $maxFailures = (int) config('sk_official_auth.rate_limit.max_failures_per_window', 5);
        $maxLockMinutes = (int) config('sk_official_auth.rate_limit.max_lock_minutes', 60);
