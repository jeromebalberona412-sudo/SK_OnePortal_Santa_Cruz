...
<head>
    ...
    <title>Activate Account - SK Officials</title>
    @vite([
        ...
        <div class="sk-login-section">
            <div class="sk-login-card">
                <div class="card-header">
                    ...
                    <p class="card-subtitle">Enter the email address registered to your account. If your previous activation link expired, we can send you a new activation link.</p>
                </div>
                ...
                <form class="sk-login-form" id="forgotPasswordForm" method="POST" action="{{ route('account.activation.send') }}" novalidate>
                    ...
                    <button type="submit" class="sk-submit-btn" id="submitBtn">
                        <span id="fpBtnText">Send Activation Link</span>
                    </button>
                </form>
