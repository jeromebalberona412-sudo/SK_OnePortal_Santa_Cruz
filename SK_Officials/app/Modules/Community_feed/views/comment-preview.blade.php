<div class="cp-shell" id="commentPreviewShell" hidden>
    <article class="cp-modal" id="commentPreviewModal" role="dialog" aria-modal="true" aria-labelledby="cpTitle">
        ...
        <footer class="cp-composer" id="cpComposer">
            <img src="{{ $barangayLogoUrl ?: asset('images/SK_OnePortal_logo.png') }}" alt="You" class="cp-composer-avatar" id="cpComposerAvatar">
            <div class="cp-composer-box">
                <input type="text" id="cpCommentInput" class="cp-composer-input" maxlength="500" placeholder="Comment as {{ $user->name ?? 'SK Official' }}" autocomplete="off">
