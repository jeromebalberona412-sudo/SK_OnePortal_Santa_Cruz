{{-- Read-only KK Survey Questionnaire — same layout as Kabataan kk-profiling-form-fields --}}
<div class="kk-profiling-view-root">
    <div class="kkp-paper kk-view-paper kk-profiling-form-scroll">
            ...
            <div class="kkp-form-title-col">
                ...
                <div class="kkp-form-header-fields">
                    <div class="kkp-hdr-field kkp-hdr-field--respondent">
                        ...
                        <span class="kkp-hdr-input kkp-hdr-input-readonly kkp-hdr-input-auto" id="kkViewRespondentNumber"></span>
                    </div>
        ...
        <div class="kkp-name-row">
            <div class="kkp-name-col">
                <div class="kkp-name-input-wrap">
                    <span class="kkp-uline kkp-name-input kkp-view-value" id="kkViewLastName"></span>
                </div>
                <span class="kkp-col-label">Last Name</span>
            </div>
            <div class="kkp-name-col">
                <div class="kkp-name-input-wrap">
                    <span class="kkp-uline kkp-name-input kkp-view-value" id="kkViewFirstName"></span>
                </div>
                <span class="kkp-col-label">First Name</span>
            </div>
            <div class="kkp-name-col">
                <div class="kkp-name-input-wrap">
                    <span class="kkp-uline kkp-name-input kkp-view-value" id="kkViewMiddleName"></span>
                </div>
                <span class="kkp-col-label">Middle Name</span>
            </div>
            <div class="kkp-name-col kkp-name-col-sm">
                <span class="kkp-uline kkp-uline-select kkp-view-value" id="kkViewSuffix"></span>
        ...
        <div class="kkp-loc-row">
            <div class="kkp-loc-col">
                <span class="kkp-uline kkp-readonly kkp-view-value" id="kkViewRegion"></span>
                <span class="kkp-col-label">Region</span>
            </div>
            <div class="kkp-loc-col">
                <span class="kkp-uline kkp-readonly kkp-view-value" id="kkViewProvince"></span>
                <span class="kkp-col-label">Province</span>
            </div>
            <div class="kkp-loc-col">
                <span class="kkp-uline kkp-readonly kkp-view-value" id="kkViewCity"></span>
                <span class="kkp-col-label">City/Municipality</span>
            </div>
            <div class="kkp-loc-col">
                <span class="kkp-uline kkp-readonly kkp-view-value" id="kkViewBarangay"></span>
                <span class="kkp-col-label">Barangay</span>
            </div>
            <div class="kkp-loc-col">
                <span class="kkp-uline kkp-uline-select kkp-view-value" id="kkViewPurokZone"></span>
                <span class="kkp-col-label">Purok/Sitio/Zone</span>
            </div>
        </div>
                ...
                <div class="kkp-age-dob-row">
                    <div class="kkp-inline-pair kkp-inline-pair--age">
                        ...
                        <div class="kkp-age-select-box">
                            <span class="kkp-uline kkp-uline-age kkp-view-value" id="kkViewAge"></span>
                        </div>
                    </div>
            ...
            <div class="kkp-demo-col">
                ...
                <div class="kkp-demo-block">
                    ...
                    <div class="kkp-demo-block-options kkp-youth-age-group-readonly">
                        ...
                        <label class="kkp-chk-lbl kkp-chk-lbl--readonly kkp-view-chk"><input type="checkbox" class="kkp-sq-chk" id="kkViewYAG_Young" disabled> Young Adult (25-30 yrs old)</label>
                    </div>
                </div>
                <div class="kkp-demo-block">
                ...
                <div class="kkp-voter-questions-wrap">
                    <div class="kkp-voter-questions-grid">
                        <div class="kkp-voter-questions-col">
                            ...
                            <div class="kkp-demo-block kkp-assembly-question" id="kkViewAssemblyQuestion">
                                <div class="kkp-demo-block-label">Have you attended a KK Assembly?</div>
                                <div class="kkp-demo-block-options">
                                    <label class="kkp-chk-lbl kkp-assembly-chk-yes kkp-view-chk">
                                        <input type="checkbox" class="kkp-sq-chk" id="kkViewKK_Yes" disabled> Yes
                                        <span class="kkp-assembly-arrow kkp-assembly-arrow--yes" aria-hidden="true">→</span>
                                    </label>
                                    <label class="kkp-chk-lbl kkp-assembly-chk-no kkp-view-chk">
                                        <input type="checkbox" class="kkp-sq-chk" id="kkViewKK_No" disabled> No
                        ...
                        <div class="kkp-voter-questions-col">
                            ...
                            <div class="kkp-demo-block kkp-assembly-followup" id="kkViewAssemblyYesCell">
                            ...
                            <div class="kkp-demo-block kkp-assembly-followup" id="kkViewAssemblyNoCell">
