...
<div class="schol-page-container saf-page-wrap">
    ...
    <!-- Filter Section -->
    <div id="activeProgramCard" style="display:none;background:linear-gradient(135deg, #00bcd4 0%, #0097a7 100%);border-radius:12px;padding:24px;margin-bottom:24px;box-shadow:0 4px 12px rgba(0,188,212,0.3);color:white;">
        <div style="display:flex;align-items:flex-start;justify-content:space-between;gap:16px;flex-wrap:wrap;">
            <div style="flex:1;min-width:300px;">
                <div style="display:flex;align-items:center;gap:10px;margin-bottom:12px;">
                    ...
                    <div style="font-size:18px;font-weight:700;">Active Sports Program</div>
        ...
        <div class="saf-table-wrap">
            <table class="saf-forms-table">
                ...
                <tbody id="safFormsTableBody">
                    <tr>
                        <td colspan="8" class="saf-table-empty">No sports programs yet. Click <strong>Create Program</strong> to get started.</td>
                    </tr>
                </tbody>
            </table>
        </div>
            ...
            <div class="schol-schedule-card" style="margin-bottom:20px;">
                ...
                <div class="schol-schedule-grid">
                    <div class="schol-field" style="grid-column:1/-1;">
                        ...
                        <input type="text" id="programName" class="schol-input" placeholder="Enter sports program name" maxlength="200" required>
                    ...
                    <div class="schol-field">
                        ...
                        <input type="text" id="programType" class="schol-input" value="Sports Development" readonly style="background:#f9fafb;">
                    </div>
                    <div class="schol-field">
                        ...
                        <select id="programCommittee" class="schol-input" required>
                            <option value="Sports" selected>Sports Committee</option>
                        </select>
                    </div>
                    <div class="schol-field">
                    ...
                    <div class="schol-field" style="grid-column:1/-1;">
                        ...
                        <textarea id="programDescription" class="schol-input" rows="3" placeholder="Enter sports program description" maxlength="500" style="resize:none;"></textarea>
...
<div class="schol-modal-overlay" id="closeProgramModal" style="display:none;">
    <div class="schol-modal-box schol-modal-sm">
        <div class="schol-modal-header schol-modal-header-danger">
            <h3>Close Sports Program</h3>
            <button type="button" class="schol-modal-close" id="closeProgramClose">&times;</button>
        </div>
        <div class="schol-modal-body">
            <p style="font-size:14px;color:#374151;line-height:1.6;margin-bottom:16px;">Are you sure you want to close this sports program? Once closed:</p>
