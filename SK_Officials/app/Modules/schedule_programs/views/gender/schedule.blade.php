...
<head>
    ...
    <title>Gender & Development Program Schedule - SK Officials Portal</title>
    @vite([
...
<div class="schol-page-container saf-page-wrap">
    ...
    @include('schedule_programs::partials.program-page-top', [
        'activeTab' => 'schedule',
        'pageTitle' => 'Gender & Development Program Schedule',
        'pageSubtitle' => 'Create and schedule gender and development programs for Kabataan members.',
        'programType' => 'gender',
        'programTitle' => 'Gender & Development Committee',
        'programDescription' => 'Manage gender and development programs, track applications, and evaluate participants.',
    ])

    <!-- Filter Section -->
    <div id="activeProgramCard" style="display:none;background:linear-gradient(135deg, #ec4899 0%, #db2777 100%);border-radius:12px;padding:24px;margin-bottom:24px;box-shadow:0 4px 12px rgba(236,72,153,0.3);color:white;">
        <div style="display:flex;align-items:flex-start;justify-content:space-between;gap:16px;flex-wrap:wrap;">
            <div style="flex:1;min-width:300px;">
                <div style="display:flex;align-items:center;gap:10px;margin-bottom:12px;">
                    ...
                    <div style="font-size:18px;font-weight:700;">Active Gender & Development Program</div>
        ...
        <div class="saf-table-wrap">
            <table class="saf-forms-table">
                ...
                <tbody id="safFormsTableBody">
                    <tr>
                        <td colspan="8" class="saf-table-empty">No gender & development programs yet. Click <strong>Create Program</strong> to get started.</td>
                    </tr>
                </tbody>
            </table>
        </div>
    ...
    <div class="schol-modal-box schol-modal-xl" id="scholarProgramBox">
        <div class="schol-modal-header">
            <h3>
                ...
                <span id="modalTitle">Create Gender & Development Program</span>
            </h3>
            ...
            <div class="schol-schedule-card" style="margin-bottom:20px;">
                ...
                <div class="schol-schedule-grid">
                    <div class="schol-field" style="grid-column:1/-1;">
                        ...
                        <input type="text" id="programName" class="schol-input" placeholder="Enter gender & development program name" maxlength="200" required>
                    ...
                    <div class="schol-field">
                        ...
                        <input type="text" id="programType" class="schol-input" value="Gender Sensitivity" readonly style="background:#f9fafb;">
                    </div>
                    <div class="schol-field">
                        ...
                        <select id="programCommittee" class="schol-input" required>
                            <option value="Gender & Development" selected>Gender & Development Committee</option>
                        </select>
                    </div>
                    <div class="schol-field">
                    ...
                    <div class="schol-field" style="grid-column:1/-1;">
                        ...
                        <textarea id="programDescription" class="schol-input" rows="3" placeholder="Enter gender & development program description" maxlength="500" style="resize:none;"></textarea>
...
<div class="schol-modal-overlay" id="viewProgramModal" style="display:none;">
    <div class="schol-modal-box schol-modal-lg">
        <div class="schol-modal-header">
            <h3>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>
                Gender & Development Program Details
            </h3>
...
<div class="schol-modal-overlay" id="closeProgramModal" style="display:none;">
    <div class="schol-modal-box schol-modal-sm">
        <div class="schol-modal-header schol-modal-header-danger">
            <h3>Close Gender & Development Program</h3>
            <button type="button" class="schol-modal-close" id="closeProgramClose">&times;</button>
        </div>
        <div class="schol-modal-body">
            <p style="font-size:14px;color:#374151;line-height:1.6;margin-bottom:16px;">Are you sure you want to close this gender & development program?? Once closed:</p>
