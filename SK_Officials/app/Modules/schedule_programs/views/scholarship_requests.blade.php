...
<div class="schol-page-container">
    ...
    @include('schedule_programs::partials.scholarship-page-top', [
        'activeTab' => 'requests',
        'pageTitle' => 'Scholarship Application Request',
    ...
    <div class="schol-filters-row">
        ...
        @include('schedule_programs::partials.time-dropdown-fields', [
            'prefix' => 'scholFilterStartTime',
            'label' => '',
            'inputClass' => 'schol-filter-input',
        ])
        @include('schedule_programs::partials.time-dropdown-fields', [
            'prefix' => 'scholFilterEndTime',
            'label' => '',
            'inputClass' => 'schol-filter-input',
        ])
        ...
        <div class="schol-modal-body" style="background:#f0f1f5;">
            ...
            <div class="schol-schedule-card">
                ...
                <div class="schol-schedule-grid">
                    ...
                    <div class="schol-field">
                        @include('schedule_programs::partials.time-dropdown-fields', [
                            'prefix' => 'schedOpenTime',
                            'label' => 'Open Time',
                            'inputClass' => 'schol-input',
                        ])
                    </div>
                    <div class="schol-field">
