...
<head>
    ...
    <title>Feeding Program Schedule - SK Officials Portal</title>
    @vite([
...
<div class="schol-page-container saf-page-wrap">
    ...
    @include('schedule_programs::partials.program-page-top', [
        'activeTab' => 'schedule',
        'pageTitle' => 'Feeding Program Schedule',
        'pageSubtitle' => 'Create and schedule feeding programs for Kabataan members.',
        'programType' => 'feeding',
        'programTitle' => 'Feeding Committee',
        'programDescription' => 'Manage feeding programs, track applications, and evaluate participants.',
    ])

    <!-- Filter Section -->
    <div id="activeProgramCard" style="display:none;background:linear-gradient(135deg, #14b8a6 0%, #0d9488 100%);border-radius:12px;padding:24px;margin-bottom:24px;box-shadow:0 4px 12px rgba(20,184,166,0.3);color:white;">
        <div style="display:flex;align-items:flex-start;justify-content:space-between;gap:16px;flex-wrap:wrap;">
            <div style="flex:1;min-width:300px;">
                <div style="display:flex;align-items:center;gap:10px;margin-bottom:12px;">
                    ...
                    <div style="font-size:18px;font-weight:700;">Active Feeding Program</div>
        ...
        <div class="saf-table-wrap">
            <table class="saf-forms-table">
                ...
                <tbody id="safFormsTableBody">
                    <tr>
                        <td colspan="8" class="saf-table-empty">No feeding programs yet. Click <strong>Create Program</strong> to get started.</td>
                    </tr>
                </tbody>
            </table>
        </div>
    ...
    <div class="schol-modal-box schol-modal-xl" id="scholarProgramBox">
        <div class="schol-modal-header">
            <h3>
                ...
                <span id="modalTitle">Create Feeding Program</span>
            </h3>
            ...
            <div class="schol-schedule-card" style="margin-bottom:20px;">
                ...
                <div class="schol-schedule-grid">
                    <div class="schol-field" style="grid-column:1/-1;">
                        ...
                        <input type="text" id="programName" class="schol-input" placeholder="Enter feeding program name" maxlength="200" required>
                    ...
                    <div class="schol-field">
                        ...
                        <input type="text" id="programType" class="schol-input" value="Feeding Program for KK Members" readonly style="background:#f9fafb;">
                    </div>
                    <div class="schol-field">
                        ...
                        <select id="programCommittee" class="schol-input" required>
                            <option value="Feeding" selected>Feeding Committee</option>
                        </select>
                    </div>
                    <div class="schol-field">
                    ...
                    <div class="schol-field" style="grid-column:1/-1;">
                        ...
                        <textarea id="programDescription" class="schol-input" rows="3" placeholder="Enter feeding program description" maxlength="500" style="resize:none;"></textarea>
...
<div class="schol-modal-overlay" id="closeProgramModal" style="display:none;">
    <div class="schol-modal-box schol-modal-sm">
        <div class="schol-modal-header schol-modal-header-danger">
            <h3>Close Feeding Program</h3>
            <button type="button" class="schol-modal-close" id="closeProgramClose">&times;</button>
        </div>
        <div class="schol-modal-body">
            <p style="font-size:14px;color:#374151;line-height:1.6;margin-bottom:16px;">Are you sure you want to close this feeding program?? Once closed:</p>
