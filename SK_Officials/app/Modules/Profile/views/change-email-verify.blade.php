            ...
            <div class="sk-login-card">
                <div id="ceVerifySection">
                    ...
                    <div class="ce-info-box">
                        Verification link sent! A confirmation link has been sent to <strong id="cePendingEmail">{{ $user->pending_email }}</strong>. Your current email remains active until you verify the new one.
                    </div>
